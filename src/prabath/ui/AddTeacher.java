...
public class AddTeacher extends javax.swing.JDialog {
    ...
    public AddTeacher(java.awt.Frame parent, boolean modal, TeacherDAO teacherDAO, boolean updateMode, Teacher selectedTeacher, TeacherViewer teacherViewer) {
        ...
        super(parent, modal);
        initComponents();
        btng.add(maleRadioBtn);
        btng.add(femaleRadioBtn);
            ...
            //java.sql.Date sqldate1=new java.sql.Date(new java.util.Date().getDate());
                ...
                try {
                    ...
                    if (updateMode) {
                        ...
                        if (notificationMode) {
                            try {
                                notificationDAO.notifyTeacher(selectedTeacher.getNIC(), true);
    ...
    public void addBtnSetName(String name) {
        add2Btn.setText(name);
    }

    public void cancelBtnSetName(String name) {
    ...
    private void cancelBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelBtnActionPerformed
        ...
        if (notificationMode) {
            try {
                notificationDAO.notifyTeacher(selectedTeacher.getNIC(), false);
                this.dispose();
            } catch (SQLException ex) {
                Logger.getLogger(AddTeacher.class.getName()).log(Level.SEVERE, null, ex);
            }
