...
public class ChangePassword extends javax.swing.JDialog {
    ...
    public ChangePassword(java.awt.Frame parent, boolean modal, int userType,String oldPassword,String NIC) {
        super(parent, modal);
        initComponents();
        ...
        if(userType==1){
            this.td = new TeacherDAO(con.getMyConn());
        }
        if(userType==2){
            try {
                this.cd=new ClerkDAO(con.getMyConn());
            } catch (Exception ex) {
                Logger.getLogger(ChangePassword.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        if(userType==3){
            this.sd=new StudentDAO(con.getMyConn());
        }
    }
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        if (newPassWrdTxt.getText().length() < 4) {
            ...
            // TODO add your handling code here:
                if(userType==1){
                td.changePassword(NIC,oldPassword,oldPassWrdTxt.getText(), newPassWrdTxt.getText(), confirmPassWrdTxt.getText());
                ...
                if(userType==2){
                    cd.changePassword(NIC, oldPassword, oldPassWrdTxt.getText(), newPassWrdTxt.getText(), confirmPassWrdTxt.getText());
                    if (cd.isPasswordChangeSuccessfully()) {
                    this.setVisible(false);
                    JOptionPane.showMessageDialog(rootPane, "Password changed succesfully");
                }
                cd.setPasswordChangeSuccessfully(false);
                }
                if(userType==3){
                    sd.changePassword(NIC, oldPassword, oldPassWrdTxt.getText(), newPassWrdTxt.getText(), confirmPassWrdTxt.getText());
                    if (sd.isSuccess()) {
                    this.setVisible(false);
                    JOptionPane.showMessageDialog(rootPane, "Password changed succesfully");
                    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChangePassword dialog = new ChangePassword(new javax.swing.JFrame(), true, 1,"","");
