...
public class AddClub extends javax.swing.JDialog {
    ...
    public AddClub(java.awt.Frame parent, boolean modal) {
        ...
        /* testting club dao******************************
         String[] a ={"11312133"};
         String[] a2 ={null};
         Club club =new Club("123123213w", "ass", a, "chamin", "achalya", null, null, null, null, null, null, null, a2);
        
         try {
         //clubDAO.addClub(club);
         //clubDAO.deleteClub("ass");
         //clubDAO.searchClub("leo", "Club Name");
         //clubDAO.updateClub(club, "fad");
         //clubDAO.getAllClub();
         Student student=studentDAO.getStudentObject("130274U");
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Teacher Incharge's NIC Number* :");
    ...
    public void setPreviousClubName(String previousClubName) {
        this.previousClubName = previousClubName;
    }
    ...
    private void txtClubIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtClubIdFocusLost
        try {
            List<Club> list = null;
            list = clubDAO.searchSpecificClub(txtClubId.getText(), "Club Id");

            if (!list.isEmpty() && !updateMode) {
    ...
    private void txtClubNameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtClubNameFocusLost
        try {
            List<Club> list = null;
            list = clubDAO.searchSpecificClub(txtClubName.getText(), "Club Name");
            ...
            System.out.println("Sql Error happend " + ex);
        }
    ...
    private void txtTeacherInchargeIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTeacherInchargeIdFocusLost
        ...
        try {
            System.out.println(txtTeacherInchargeId.getText());
            TeacherIn = teacherDAO.getTeacherById(txtTeacherInchargeId.getText());
            System.out.println(TeacherIn.getNameWithin());
            ...
            Logger.getLogger(AddClub.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void txtPresidentIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPresidentIdFocusLost
        try {
            ...
            System.out.println("Ther is a some sql error");
        }
    ...
    private void addClub() throws SQLException {
        ...
        //added by Malith
        if (updateMode) {
            clubDAO.updateClub(club, previousClubName);
        } else {

           
            clubDAO.addClub(club);
            TeacherIn.setAccessPriviledge(3);// check this 
    ...
    // method by Malith************************************
    public void populateGUI(Club club) {
        txtClubId.setText(club.getClubId());
        txtClubName.setText(club.getClubName());
        txtTeacherInchargeId.setText(club.getTeacherInchargeId()[0]);
        txtAdvisor.setText(club.getAdvisor());
        txtPresidentId.setText(club.getPresidentId());
        txtVicePresidentId.setText(club.getVisePresidentId());
        txtSecretaryId.setText(club.getSecretaryId());
        txtAssSecretaryId.setText(club.getAssSecretaryId());
        txtTreasurerId.setText(club.getTreasurerId());
        txtAssSecretaryId.setText(club.getAssSecretaryId());
        txtTask.setText(club.getTask());
        txtSuggestions.setText(club.getSuggestions());
        dtChooserDateOfEstablish.setDate(club.getDateOfEstablish());
        txtMembersId.setText(club.getMemberIdList()[0]);
